    ...
    <div class="page">
        ...
        <div v-if="step === 1" class="scroll">
            <div class="wrap">
                ...
                <p class="lead">
                    Прайс — единственный источник цен: панель ничего не придумывает сверх семи колонок файла. Формат
        ...
        <template v-else>
            ...
            <div class="filter-bar">
                ...
                <p class="filter-bar__note">
                    Пустая «Цена со скидкой» — скидки нет, применим розничную. Правьте строки здесь: перезаливать файл
                    не нужно, строки с ошибками не импортируются.
                </p>
            </div>
